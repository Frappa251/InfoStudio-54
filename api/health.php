...
try {
    ...
    // Eseguiamo una query banalissima ("SELECT 1") solo per vedere
    // se la connessione al database risponde correttamente.
    db()->query('SELECT 1');

    // Se siamo arrivati qui senza eccezioni, tutto funziona
    json_response([
        'success'  => true,
    ...
    // Se la query fallisce, c'è qualche problema col database
    json_response([
        'success' => false,
