...
$(document).ready(function () {
    ...
    if (formRegistrazione != null) {
        ...
        formRegistrazione.addEventListener('submit', function (evento) {
            ...
            // -- Controlli lato client (sono solo un primo filtro,
            //    quelli "veri" li fa comunque PHP) --
...
// - classeCSS:    'error-msg' oppure 'success-msg' (lo stile è nel CSS)
function mostraMessaggio(elementoForm, testo, classeCSS) {

    // Per prima cosa rimuoviamo eventuali messaggi precedenti,
    // così non se ne accumulano uno sotto l'altro.
